...
export const config = {
    service: {
        ...
        systemUnavailableURL: env.get('SYSTEM_UNAVAILABLE_URL').default('/unavailable').asString(),
    ...
    authentication: {
        ...
        mockAuthenticatedUserId: env.get('MOCK_AUTHENTICATED_USER_ID').default('5e5688324203fc40043591aa').asString(), // user1
