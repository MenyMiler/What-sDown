...
interface addStaffBedroomToEventModalProps {
    request: any;
}

const AddStaffBedroomToEventCourseModal = ({ request }: addStaffBedroomToEventModalProps) => {
...
export default AddStaffBedroomToEventCourseModal;
